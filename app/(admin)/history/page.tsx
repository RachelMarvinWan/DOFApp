            ...
            <table className="min-w-full bg-white border border-gray-300">
              <thead className="bg-gray-200 sticky top-0 z-10">
                <tr>
                  ...
                  <th onClick={() => requestSort('farm')} className={`cursor-pointer text-left p-4 ${sortConfig.key === 'organisation' ? 'text-blue-500' : ''} font-normal justify-between items-center`}>
                    Organisation <span className="text-xs text-gray-400">{getArrow('organisation')}</span>
                  </th>
                  {/*
                  <th onClick={() => requestSort('area')} className={`cursor-pointer text-left p-4 ${sortConfig.key === 'area' ? 'text-blue-500' : ''} font-normal justify-between items-center`}>
                    Area <span className="text-xs text-gray-400">{getArrow('area')}</span>
                  </th>
                  */}
